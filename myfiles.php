                   ...
                   // $files = null;
                    if($folder==0){
                        ...
                        // // search
                         if(isset($_GET["q"]) && $_GET["q"]!=""){
                           $q=$_GET["q"];
                            $files=mysqli_query($con,"select * from file where folder_id=$file_id_folder and  (filename like '%$q%' or description like '%$q%') order by created_at desc");
                     }else{
...
?>
                                    ...
                                    <td style="width:223px;">
                                        <a href="filepermision.php?id=<?php echo $file['code']; ?>"
                                            class="btn btn-xs btn-default"><i class="fa fa-globe"></i> Compartir</a>
                                        <a href="editfile.php?id=<?php echo $file['code'];?>"
                                            class="btn btn-xs btn-warning"><i class="fa fa-pencil"></i> Editar</a>
                                        <a href="action/delfile.php?id=<?php echo $file['code']; ?>&tkn=<?php echo $_SESSION["tkn"]?>"
