    ...
    <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
        <section class="content-header"><!-- Content Header (Page header) -->
            ...
            <ol class="breadcrumb">
                ...
                <li class="newfile.php">Nuevo Archivo</li>
            </ol>
        </section>
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group ">
                                        <label class="" for="iptImagen"><i
                                            ...
                                            <span class="small">Seleccionar Archivo</span><span class="text-danger">*</span></label>
                                        <input type="file" min="0" class="form-control form-control-sm"
                                            id="iptImagen"name="filename"
                                            placeholder="fecha terminación" required>
                                        <div class="invalid-feedback">Elija un archivo</div>
                                    </div>
